...
def _build_system_prompt(user_memories: str) -> str:
    ...
    base_prompt = (
        ...
        "   - If insufficient but other angles exist: retry with a different query\n"
        "   - If completely irrelevant or limit reached: honestly state inability to answer\n"
        "4. Maximum 3 knowledge base calls per conversation turn; avoid duplicate queries\n"
